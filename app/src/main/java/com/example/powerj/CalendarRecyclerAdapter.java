...
public class CalendarRecyclerAdapter extends RecyclerView.Adapter<CalendarRecyclerAdapter.ViewHolder> {
    private ArrayList<com.example.powerj.CalendarRecyclerItem> lists = new ArrayList<>();
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        com.example.powerj.CalendarRecyclerItem item = lists.get(position);
        switch(viewType) {
            case 0:
                break;
            case 1:
    ...
    public void addItem(int key, int day, boolean schedule, int count){
        com.example.powerj.CalendarRecyclerItem item = new com.example.powerj.CalendarRecyclerItem();
    ...
    private void selItem(ViewHolder holder,int day){
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(v.getContext(), com.example.powerj.CalendarScheduleActivity.class);
