...
public class CalendarScheduleActivity extends AppCompatActivity {
    ...
    private com.example.powerj.CalendarScheduleRecyclerAdapter adapter_calendar_schedule;
    ...
    private void btn_clicked(){
        btn_calenadar_schedule_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CalendarScheduleActivity.this, com.example.powerj.CalendarScheduleAddActivity.class);
    ...
    private void init_rv(){
        ...
        adapter_calendar_schedule = new com.example.powerj.CalendarScheduleRecyclerAdapter(year, month, day);
    ...
    private void load_values(){
        if(sqliteDB != null){
            ...
            while(cursor_calendar_schedule.moveToNext()){
                adapter_calendar_schedule.addItem(cursor_calendar_schedule.getString(1),cursor_calendar_schedule.getString(2), cursor_calendar_schedule.getString(3));
            }
        }
