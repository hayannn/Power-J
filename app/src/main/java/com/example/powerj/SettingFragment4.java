...
public class SettingFragment4 extends PreferenceFragment {
...
//<PregerenceScreen>클래스를 통해 화면 설계 시작..
        ...
        addPreferencesFromResource(R.xml.setting4);

//SharedPreference객체를 참조하여 설정상태에 대한 제어 가능..
        pref =PreferenceManager.getDefaultSharedPreferences(getActivity());

//key 값이 "message"인 설정의 저장값 가져오기.
        boolean isMessage= pref.getBoolean("message4", false); //두번째 파라미터 : default값
