...
public class SettingFragment3 extends PreferenceFragment {
...
//key 값이 "message"인 설정의 저장값 가져오기.
        boolean isMessage= pref.getBoolean("message3", false); //두번째 파라미터 : default값
